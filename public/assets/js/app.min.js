class Components {
    ...
    initAppSearch() {
        ...
        const t = this;
        this.searchOption && ["focus", "keyup"].forEach(function(e) {
        ...
        }), t.searchClose && t.searchClose.addEventListener("click", function() {
...
class FormAdvanced {
    ...
    initFormChoices() {
        document.querySelectorAll("[data-choices]").forEach(function(e) {
            var t = {},
                a = e.attributes;
            a["data-choices-groups"] && (t.placeholderValue = "This is a placeholder set in the config"), a["data-choices-search-false"] && (t.searchEnabled = !1), a["data-choices-search-true"] && (t.searchEnabled = !0), a["data-choices-removeItem"] && (t.removeItemButton = !0), a["data-choices-sorting-false"] && (t.shouldSort = !1), a["data-choices-sorting-true"] && (t.shouldSort = !0), a["data-choices-multiple-remove"] && (t.removeItemButton = !0), a["data-choices-limit"] && (t.maxItemCount = a["data-choices-limit"].value.toString()), a["data-choices-limit"] && (t.maxItemCount = a["data-choices-limit"].value.toString()), a["data-choices-editItem-true"] && (t.maxItemCount = !0), a["data-choices-editItem-false"] && (t.maxItemCount = !1), a["data-choices-text-unique-true"] && (t.duplicateItemsAllowed = !1, t.paste = !1), a["data-choices-text-disabled-true"] && (t.addItems = !1), a["data-choices-text-disabled-true"] ? new Choices(e, t).disable() : new Choices(e, t)
        })
    }
    init() {
...
class Code {
    initCode() {
        ...
        Prism.plugins.NormalizeWhitespace.setDefaults({
            ...
            "left-trim": !0,
            "right-trim": !0
        }), document.querySelector(".docs-nav a") && new Gumshoe(".docs-nav a")
    }
    init() {
        this.initCode()
    }
...
class Dragula {
    initDragula() {
        document.querySelectorAll("[data-plugin=dragula]").forEach(function(e) {
            ...
            let a = [];
            if (t)
                for (let e = 0; e < t.length; e++) a.push(document.querySelectorAll("#" + t[e])[0]);
            else a = [e];
...
class ThemeLayout {
    ...
    initVerticalMenu() {
        ...
        t.forEach(e => {
            ...
            var e, i, n, o, r, s, t = document.querySelector(".nav-item li a.active");

            function l() {
                var e, t, a = (e = s += 20, a = o, t = r, (e /= n / 2) < 1 ? t / 2 * e * e + a : -t / 2 * (--e * (e - 2) - 1) + a);
    ...
    initSwitchListener() {
        ...
        e && e.addEventListener("click", function() {
            ...
            e.addEventListener("click", function() {
                var e = a.config.menu.size,
                    t = a.html.getAttribute("data-menu-size", e);
                "sm-hover-active" === e && ("sm-hover-active" === t ? a.changeMenuSize("sm-hover", !0) : a.changeMenuSize("sm-hover-active", !0)), "sm-hover" === e && ("sm-hover" === t ? a.changeMenuSize("sm-hover-active", !0) : a.changeMenuSize("sm-hover", !0))
            })
        })
    }
    showBackdrop() {
    ...
    setSwitchFromConfig() {
        sessionStorage.setItem("__RAYDAR_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll(".settings-bar input[type=radio]").forEach(function(e) {
            e.checked = !1
        });
        var e, t, a, i = this.config;
        i && (e = document.querySelector("input[type=radio][name=data-bs-theme][value=" + i.theme + "]"), t = document.querySelector("input[type=radio][name=data-topbar-color][value=" + i.topbar.color + "]"), a = document.querySelector("input[type=radio][name=data-menu-size][value=" + i.menu.size + "]"), i = document.querySelector("input[type=radio][name=data-menu-color][value=" + i.menu.color + "]"), e && (e.checked = !0), t && (t.checked = !0), a && (a.checked = !0), i && (i.checked = !0))
    }
    init() {
